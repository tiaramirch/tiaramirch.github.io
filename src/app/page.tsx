...
export default function Home() {
  ...
  return (
    <div className="h-svh bg-[#1f1f2d] p-1 sm:py-8 sm:px-28 font-sans">
      <div className="flex flex-col w-full h-full bg-gray-400 rounded-3xl text-white">
        ...
        {/* Chat window */}
        <div className="flex flex-col w-full h-[77%] p-3 my-1 sm:p-10">
          {/* Render messages */}
          ...
          {currentMessage && (
            <div className="flex justify-start">
              <div className="bg-[#1f1f2d] text-white rounded-xl p-3 max-w-[70%]">
                {currentMessage}
              </div>
            </div>
          )}
        ...
        <div className="flex flex-row items-center justify-center w-full h-[11%] p-3">
          <div className="flex flex-row w-[90%] h-full bg-gray-300 rounded-2xl items-center p-1">
            ...
            <SendHorizontal
              ...
              style={{
                pointerEvents:
                  inputValue === sendPhrases[0] || stage == 1 ? "auto" : "none",
              }}
            />
          </div>
        </div>
